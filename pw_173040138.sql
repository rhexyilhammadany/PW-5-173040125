...
--
-- Host: 127.0.0.1
-- Generation Time: 16 Apr 2018 pada 18.56
...
(1, 'Komodo', 'komodo.jpg', 'Varanus Komodensi', 'Fauna', 'Spesies kadal terbesar di dunia dan hanya ada di Pulau Komodo, Rinca, Gili Montang, Flores dan Nusa Tenggara (Gili Dasami). Ditemukan pada tahun 1910 oleh seorang peneliti dari barat. Panjang rata-rata 2 – 3 meter. Dan memiliki gigitan beracun.'),
...
(3, 'Badak Jawa', 'badak.jpg', 'Rhinoceros Sondaicus', 'Fauna', 'Badak ini memiliki genus yang sama dengan badak india dan memiliki kulit bermosaik yang menyerupai baju baja. Badak jawa memiliki panjang sekitar 3 – 3,2 m dan tinggi sekitat 1,4 – 1,7m.'),
...
(10, 'Daun Payung', 'payung.jpg', 'Johannesteijsmannia Altifrons', 'Flora', 'Sejenis palem-paleman yang mempunyai daun besar dan lebar. Merupakan Tanaman di Indonesia tepatnya di Sumatera Utara. Mempunyai ukuran daun panjang sekitar 3-6meter denagn lebar 1m. Tanaman ini tidak tahan terhadap paparan sinar matahari langsung.');
